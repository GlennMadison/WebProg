<div class="d-flex flex-column shadow bg-dark"
    ...
    <div class="list-group list-group-flush flex-grow-1">
        <div
            ...
            <a href="{{ route('threads.search') }}" class="fw-semibold fs-6 text-decoration-none text-white">Home</a>
        </div>
        <div class="d-flex align-items-center justify-content-center list-group-item list-group-item-action bg-dark ">
            ...
            <a href="{{ route('threads.search', ['filter' => 'popular']) }}"
                class="fw-semibold fs-6 text-decoration-none text-white">Popular</a>
        </div>
    </div>
    ...
    <div class="list-group list-group-flush">
        <div class="d-flex align-items-center justify-content-center list-group-item list-group-item-action bg-dark">
            ...
            <a href="/" class="fw-semibold fs-6 text-decoration-none text-white">About Us</a>
        </div>
        <div
            ...
            <a href="/" class="fw-semibold fs-6 text-decoration-none text-white">Help</a>
        </div>
    </div>
</div>